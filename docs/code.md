...
The [Tutorial page](/mock-up/tutorial/#how-to-calculate-hourly-fwi-the-new-fwi2025) includes steps to run the code with a publicly available test dataset.
...
To get started, a test script and test data can be accessed on the ng-cffdrs repository.  See the [Tutorial page](/mock-up/tutorial/#how-to-calculate-hourly-fwi-the-new-fwi2025) for step-by-step instructions.  

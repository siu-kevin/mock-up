...
Columns are added to the input data table, and a second summary data table is generated. The following are output columns that are appended to the hourly weather data table: 
